Imports System.Xml
Public Class rptListagemProjetos
    ...
    ''' </summary>
    Dim sNameXML As String = "rptListagemProjetos.xml"
    Dim sNameRpt As String = "RPT_VW_LISTAGEM_PROJETOS"
    Dim sPasta As String = "Relatórios\XML"
    Dim sQuery As String = "SELECT * FROM VW_LISTAGEM_PROJETOS"
    Private Sub rptListagemProjetos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadReports()
    End Sub
    ''' <summary>
