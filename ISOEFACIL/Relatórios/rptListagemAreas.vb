...
Public Class rptListagemAreas
    ...
    ''' </summary>
    Dim sNameXML As String = "rptListagemAreas.xml"
    Dim sNameRpt As String = "RPT_VW_LISTAGEM_AREAS"
    Dim sPasta As String = "Relatórios\XML"
    Dim sQuery As String = ("SELECT * FROM VW_LISTAGEM_AREAS")

    Private Sub rptListagemAreas_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadReports()
    End Sub
