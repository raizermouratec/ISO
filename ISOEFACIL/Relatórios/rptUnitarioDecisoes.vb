...
Public Class rptUnitarioDecisoes
    ...
    Private Sub rptUnitarioDecisoes_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

        Dim id As Integer = 0
        id = acListaDecisoes.gridDecisoes(acListaDecisoes.gridDecisoes.RowSel, 1)

        sNameXML = "rptUnitarioDecisoes.xml"
        sNameRpt = "RPT_VW_LISTAGEM_DECISOES"
        sPasta = "Relatórios\XML"
        sQuery = ("SELECT * FROM VW_LISTAGEM_ANALISE_CRITICA_DECISOES WHERE ID_ANALISE_CRITICA_DECISOES = " & id)
