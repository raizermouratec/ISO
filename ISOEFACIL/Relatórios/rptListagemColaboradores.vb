...
Public Class rptListagemColaboradores
    ...
    ''' </summary>
    Dim sNameXML As String = "rptListagemColaboradores.xml"
    Dim sNameRpt As String = "RPT_VW_LISTAGEM_COLABORADORES"
    Dim sPasta As String = "Relatórios\XML"
    Dim sQuery As String = ("SELECT * FROM VW_LISTAGEM_COLABORADORES")

    Private Sub rptListagemColaboradores_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadReports()
    End Sub
