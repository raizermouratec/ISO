...
Public Class rptListagemPolitica
    ...
    ''' </summary>
    Dim sNameXML As String = "rptListagemPolitica.xml"
    Dim sNameRpt As String = "RPT_VW_LISTAGEM_POLITICA"
    Dim sPasta As String = "Relatórios\XML"
    Dim sQuery As String = "SELECT * FROM VW_LISTAGEM_POLITICA"

    Private Sub rptListagemPolitica_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadReports()
    End Sub
