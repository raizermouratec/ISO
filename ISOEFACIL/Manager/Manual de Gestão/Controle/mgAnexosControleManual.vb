...
Public Class mgAnexosControleManual

#Region "VARIAVEIS"

    ''' ANEXO
    Private ANEXO() As Byte
    Public Modulo As String = "MANUAL DE GESTÃO"
    Public Tela As String = "mgAnexosControleManual"
    Public idAnexosControleManuais As String

    'Pega Id Registro
    Public WriteOnly Property AnexosControleManuais() As String
        Set(ByVal value As String)
            Me.idAnexosControleManuais = value
        End Set
    End Property
...
#Region "LOAD"
    ...
    Private Sub mgAnexosControleManual_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        'carregaListaAnexos(idAnexosControleManuais)
    End Sub
