...
Public Class planoAnualAc

#Region "ADD"

    Public Function Add(ByVal INSTRUMENTO As Integer, _
        ...
        Dim _cmdText As String = "INSERT_PLANO_CALIBRACAO"
        ...
        Try
            ...
            With _Command.Parameters
                .AddWithValue("@ID_INSTRUMENTOS", INSTRUMENTO)
...
#Region "ADD REALIZA"
    ...
    Public Function AddRealiza(ByVal INSTRUMENTO As Integer, _
                        ByVal ID_PLANO_CALIBRACAO As Integer, _
                        ByVal TIPO As String, _
                        ByVal ANO As String, _
        ...
        Dim _Connection As SqlConnection
        Dim _Command As SqlCommand
        Dim _cmdText As String = "INSERT_REALIZA_CALIBRACAO"
        ...
        Try
            ...
            With _Command.Parameters
                .AddWithValue("@ID_INSTRUMENTOS", INSTRUMENTO)
                .AddWithValue("@ID_PLANO_CALIBRACAO", ID_PLANO_CALIBRACAO)
                .AddWithValue("@TIPO", TIPO)
                .AddWithValue("@ANO", ANO)
                .AddWithValue("@MES", MES)
...
#Region "JAN"
    ...
    Public Function Update_Plano_JAN(ByVal ID_PLANO_CALIBRACAO As Integer, _
...
#Region "FEV"
    ...
    Public Function Update_Plano_FEV(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "MAR"
    ...
    Public Function Update_Plano_MAR(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "ABR"
    ...
    Public Function Update_Plano_ABR(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "MAI"
    ...
    Public Function Update_Plano_MAI(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "JUN"
    ...
    Public Function Update_Plano_JUN(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "JUL"
    ...
    Public Function Update_Plano_JUL(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "AGO"
    ...
    Public Function Update_Plano_AGO(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "SET"
    ...
    Public Function Update_Plano_SET(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "OUT"
    ...
    Public Function Update_Plano_OUT(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "NOV"
    ...
    Public Function Update_Plano_NOV(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "DEZ"
    ...
    Public Function Update_Plano_DEZ(ByVal ID_PLANO_CALIBRACAO As Integer, _
                     ByVal TIPO As Integer) As Boolean
...
#Region "REALIZA PLANO"
    ...
    Public Function Update_RealizaPlano(ByVal ID_PLANO_CALIBRACAO As Integer, _
                                         ByVal MES As String, _
        ...
        Dim _Connection As SqlConnection
        Dim _Command As SqlCommand
        Dim _cmdText As String = "[UPDATE_REALIZA_PLANO]"
